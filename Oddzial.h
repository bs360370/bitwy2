...
protected:
    ...
    double modifier_atak;                                                       // modifiery sluza do opisu kar, bonusów i wartosci wsparcia na poszczegolne oddzialy
...
public:
    ...
    virtual void policz_modifier(Oddzial*** tab1, Wspolrzedne*** tab2) = 0;     // liczenie modifierow
    ...
    void aktualizuj_wspolrzedne(int x, int y);                                  // przy przesuwaniu - zmiana polozenia
    void aktualizuj_morale(double strata);                                      // strata morale przy pojedynczym ataku na oddzial
    void aktualizuj_morale_2();                                                 // strata morale po smierci oddzialu
    ...
    bool czy_martwy();                                                          // 1 jesli aktualna liczebnosc = 0
